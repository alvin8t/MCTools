...
function syncReleases(outputDirectory, options) {
    (_builderUtil || _load_builderUtil()).log.info("syncing releases to build delta package");
...
class SquirrelBuilder {
    ...
    createEmbeddedArchiveFile(nupkgPath, dirToArchive) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            yield (0, (_builderUtil || _load_builderUtil()).exec)((_zipBin || _load_zipBin()).path7za, (0, (_archive || _load_archive()).compute7zCompressArgs)("zip", {
                isRegularFile: true,
